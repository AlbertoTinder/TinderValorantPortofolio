const translations = {
    en: {
        ...
        subtitle: "Click my name to learn more about my vision.",
        back: "BACK",
        ...
        card_chess_text: "I understand VALORANT as a chessboard. It's about securing numerical superiority, anticipating enemy movements, and executing strategies with precise timing.",
        card_psy_title: "Psychological Pillar",
        card_psy_text: "Players carry a massive emotional load. A coach must be their psychological pillar, providing emotional stability and mental strength under extreme pressure.",
    ...
    jp: {
        role: "プロフェッショナルコーチ",
        subtitle: "名前をクリックして、私のビジョンについてもっと知る。",
        back: "戻る",
        ...
        card_psy_text: "選手は巨大な感情的負荷を抱えています。コーチは彼らの心理的な支えとなり、極度のプレッシャーの下でも感情の安定と精神的な強さを提供しなければなりません。",
